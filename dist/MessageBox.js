...
var compiler = function compiler(message) {
  return function (context) {
    var compiledMessage = message;
    var result = void 0;
    while ((result = templateRe.exec(message)) !== null) {
      // eslint-disable-line no-cond-assign
      var variable = result[2];
      compiledMessage = compiledMessage.replace(new RegExp('{{' + variable + '}}', 'g'), context[variable]);
    }
